...
MoovingX = () => {
  ...
  if (this.state.pointLeft > 355 || this.state.pointLeft < 0 //|| this.BriqueX(140, 50) || this.BriqueX(140, 150) || this.BriqueX(140, 250)
  ){
...
MoovingY = () => {
  ...
  if (this.state.pointTop > 647 || this.state.pointTop < 0 //|| this.BriqueY(140, 50) || this.BriqueY(140, 150) || this.BriqueY(140, 250)
  ){
